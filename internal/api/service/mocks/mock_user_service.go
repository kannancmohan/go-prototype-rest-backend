...
//
//	mockgen -destination=../service/mocks/mock_user_service.go -package=mockservice github.com/kannancmohan/go-prototype-rest-backend/internal/api/handler UserService
//
