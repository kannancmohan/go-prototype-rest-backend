...
//
//	mockgen -destination=../service/mocks/mock_posts.go -package=mockservice github.com/kannancmohan/go-prototype-rest-backend/internal/api/handler PostService
//
