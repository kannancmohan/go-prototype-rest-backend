...
//
//	mockgen -destination=mocks/mock_messagebroker.go -package=mockstore github.com/kannancmohan/go-prototype-rest-backend/internal/common/domain/store PostMessageBrokerStore
//
